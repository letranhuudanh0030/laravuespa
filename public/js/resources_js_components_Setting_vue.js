...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    generalToken: function generalToken() {
      var _this = this;

      axios.post("http://localhost:8000/api/general-token", {
...
var render = function () {
  ...
  return _c("div", [
    ...
    _c("hr"),
    _vm._v(" "),
    _c("h1", { staticClass: "font-normal text-2xl mb-4 mt-6" }, [
      _vm._v("General Token:"),
    ]),
    _vm._v(" "),
    _c("input", {
      directives: [
      ...
      attrs: { type: "text", placeholder: "Your Laracasts API Token" },
    ...
    _c(
      "button",
      {
        staticClass: "button hover:bg-hd-blue hover:text-white uppercase",
        on: { click: _vm.generalToken },
      },
      [_vm._v("\n        General New Access Token\n    ")]
    ),
    _vm._v(" "),
    _vm.newToken
      ? _c("p", { staticClass: "my-4 text-xl text-green-500" }, [
          _c("strong", { staticClass: "text-hd-black" }, [
            _vm._v("New API Token:"),
          ]),
          _vm._v(" " + _vm._s(_vm.newToken) + "\n    "),
        ])
      : _vm._e(),
  ])
}
